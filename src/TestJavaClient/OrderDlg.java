...
public class OrderDlg extends JDialog {
    ...
    public OrderDlg( SampleFrame owner) {
        ...
        addGBComponent(pOrderDetails, new JLabel( "Account"), gbc, COL1_WIDTH, GridBagConstraints.RELATIVE );
        addGBComponent(pOrderDetails, m_account, gbc, COL2_WIDTH, GridBagConstraints.REMAINDER);
    ...
    void onOk() {
        ...
        try {
            ...
            m_order.account(m_account.getText());
